...
export default function Home(){
    ...
    return (
        ...
        <div className="flex_col_center p-5 border border-2 border-black rounded shadow-lg position-absolute top-50 start-50 translate-middle" style={{width: "30%"}}>
            ...
            <button onClick={ () => { navigate("/play")} } className="button w-50 py-2 my-1" style={{height: "fit-content"}}> Play </button>            
            <button onClick={ () => { navigate("/multiplayer")} } className="button w-50 py-2 my-1" style={{height: "fit-content"}}> Online Multiplayer </button>            
            <button onClick={ handleInstructions } className="button w-50 py-2 my-1" style={{height: "fit-content"}}> Instructions </button>                       
