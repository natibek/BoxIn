...
export default function NewGame() {
  ...
  return (
    <div
      className="flex_col_center bg-white shadow-lg gap_20 px-3 py-5 m-4 rounded border border-1 border-black modal-s"
    ...
    >
      ...
      <div className="input_div gap_10 d-flex flex-column position-relative">
        <div id="num_players_text" className="slider_label text-center">
          {num_players}
        </div>
      ...
      <button className="button bg-light-grey rounded px-5 py-2 mt-3" onClick={handleGameSetting}>
        Play
      </button>
    </div>
  );
